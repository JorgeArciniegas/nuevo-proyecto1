...
export const environment: Environment = {
  ...
  license: LICENSE_TYPE.KYRON,
  baseApiUrl: 'https://qacom-apikyron.ody-services.net',
  pageTitle: 'Kyron - KIOSK',
  theme: 'kyron',
  faviconPath: 'app/themes/skins/kyron/image/Logo-header.png',
  currencyDefault: 'EUR',
